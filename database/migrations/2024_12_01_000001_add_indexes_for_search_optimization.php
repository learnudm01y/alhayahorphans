...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::connection('mysql')->hasTable('data')) {
        ...
        if (Schema::connection('mysql')->hasTable('re_people')) {
        ...
        if (Schema::connection('mysql')->hasTable('dead_people')) {
        ...
        if (Schema::connection('civilregistry')->hasTable('persons')) {
