            ...
            <div class="row">
                ...
                <div class="col-md-12 mt-3">
                    ...
                    <div class="mb-3 d-flex justify-content-end">
                        <button type="button" id="toggleAllPermissionsBtn" class="btn btn-dark btn-sm">
                                                                            ...
                                                                            <li>
                                                                                <label class="node leaf mb-0" for="{{ $checkboxId }}">
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        {{ Form::checkbox('permission[]', $perm->id, false, ['class' => 'custom-control-input', 'id' => $checkboxId]) }}
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const refreshButtonState = () => {
            const allChecked = permissionCheckboxes().every(checkbox => checkbox.checked);
