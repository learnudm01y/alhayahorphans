...
<style>
    ...
    table.dataTable {
        ...
        color: #000 !important; /* النص باللون الأسود */
        background: #fff;
    ...
    table.dataTable tbody tr.selected td {
        ...
        color: inherit !important; /* إبقاء النص ظاهر */
    }
...
<div class="card shadow-sm border-0">
    ...
    <div class="card-body py-4">
        ...
        <ul class="nav nav-tabs nav-line-tabs mb-5 fs-6">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="{{ route('admin.role.management101') }}">الإدارة</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="{{ route('admin.role.management102') }}">المستخدمين</a>
            </li>
        </ul>
