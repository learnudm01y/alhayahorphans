        ...
        {!! Form::model($user, ['method' => 'PATCH', 'route' => ['users.update', $user->id], 'class' => 'form']) !!}
            ...
            <div class="text-center">
                ...
                <button type="submit" class="btn btn-primary d-inline-flex align-items-center">
                    ...
                    <span class="ms-2">حفظ التغييرات</span>
                </button>
            </div>
            <!--end::Actions-->
        {!! Form::close() !!}
...
.select2-container--bootstrap5
  ...
  position: relative !important;       /* لضبط أيقونة الإغلاق مطلقاً داخله */
  padding: 5px 32px 5px 12px !important; /* 32px بافر على يمين النص لإفساح المجال للأيقونة */
  margin: 4px !important;
  background-color: #f3f6f9;
  border-radius: 4px !important;
  direction: ltr !important;           /* يكسر تأثير RTL داخل الـ tag */
}
...
.select2-container--bootstrap5
  ...
  top: 50% !important;
  right: 8px !important;              /* تحدد البُعد الثابت من حافة الـ tag */
