<?php
// فحص جميع المجلدات وإضافة محتوياتها لقاعدة البيانات

echo "🔍 فحص جميع المجلدات وإضافة محتوياتها\n";
echo "=" . str_repeat("=", 60) . "\n\n";
...
try {
    ...
    foreach ($folders as $folderPath) {
        ...
        // تخطي المجلدات غير الرقمية أو التي لا تتبع نمط المجلدات
...
echo "\n" . str_repeat("=", 60) . "\n";
echo "🎉 انتهى! الآن جميع المجلدات متاحة في قاعدة البيانات\n";
?>
