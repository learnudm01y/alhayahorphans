...
class SponsorFieldSetting extends Model
{
    ...
    protected $casts = [
        ...
        // معلومات المعيل
        'field_current_guardian' => 'boolean',
        ...
        'field_data_address' => 'boolean',
        'field_data_province' => 'boolean',
        'field_data_city' => 'boolean',
        'field_data_neighborhood' => 'boolean',
