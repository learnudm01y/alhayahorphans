...
class UserRoleManagementDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('role', function($user) {
                // إضافة شارة Bootstrap حسب الدور
            ...
            ->rawColumns(['role', 'action']) // للسماح بعرض HTML في عمود الدور والعمليات
            ->setRowId('id');
    }
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->setTableId('userrolemanagement-table')
    ...
    {
        return 'UserRoleManagement_' . date('YmdHis');
    }
}
