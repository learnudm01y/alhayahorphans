...
class UserProfileController extends Controller
{
    ...
    {
        return view('user.dashboard.component.profile');
    }
    public function profileIndex(): View
    {
        return view('user.dashboard.component.profile_index');
    }
    public function settings(): View
    {
        ...
        return view('user.dashboard.component.settings', compact('user', 'countryName', 'countries'));
    }
