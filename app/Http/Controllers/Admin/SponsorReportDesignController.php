...
class SponsorReportDesignController extends Controller
{
    ...
    public function saveReportDesign(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'single_image' => 'nullable|image|mimes:jpeg,png,jpg,heic,heif|max:5120',
            'header_image' => 'nullable|image|mimes:jpeg,png,jpg,heic,heif|max:5120',
            'main_image' => 'nullable|image|mimes:jpeg,png,jpg,heic,heif|max:5120',
            'footer_image' => 'nullable|image|mimes:jpeg,png,jpg,heic,heif|max:5120',
